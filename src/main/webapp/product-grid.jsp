...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(https://intphcm.com/data/upload/banner-thoi-trang-nam.jpg) no-repeat scroll center center / cover ;">
                            ...
                            <div class="row">
                                <div class="shop__grid__view__wrap">
                                    <div role="tabpanel" id="grid-view" class="single-grid-view tab-pane fade in active clearfix">
                                        ...
                                        <c:forEach items="${requestScope.ListFind}" var="Product">
                                            <!-- Start Single Category -->
                                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                                <div class="category">
                                                    <div class="ht__cat__thumb">
                        ...
                        <div class="htc__product__leftsidebar">
                                            ...
                                            <div class="slider__range--output">
                                                <div class="price__output--wrap">
                                                    <div class="price--output">
                                                        <span>Price :</span><input type="text" id="amount" name="Filter" readonly>
                                                    </div>
                            ...
                            <div class="ht__pro__size">
                                ...
                                <ul class="ht__size__list">
                                    <li><a href="/product?size=xs">xs</a></li>
                                    <li><a href="/product?size=s">s</a></li>
                                    <li><a href="/product?size=m">m</a></li>
                                    <li><a href="/product?size=reld">reld</a></li>
