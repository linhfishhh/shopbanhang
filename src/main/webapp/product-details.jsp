                                        ...
                                        <ul>
                                            ...
                                            <li><a href="#">pages</a>
                                                <ul>
                                                    ...
                                                    <li><a href="contact.html">contact</a></li>
                                                    <li><a href="/product">product grid</a></li>
                    ...
                    <div class="row">
                                ...
                                <div class="product__big__images">
                                    <div class="portfolio-full-image tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                                            <img src="${requestScope.Product.image}" alt="full-image">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                ...
                                <h6>Model: <span>${requestScope.Product.id}</span></h6>
                                <ul class="rating">
                                ...
                                <ul  class="pro__prize">
                                    <li class="old__prize">Price: ${requestScope.Product.price} VND</li>
                                </ul>
                                ...
                                <div class="ht__pro__desc">
                                    ...
                                    <div class="sin__desc align--left">
                                        <p><span>Size: ${requestScope.Product.size}</span></p>
