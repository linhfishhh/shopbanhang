                            ...
                            <div class="col-md-7 col-lg-8 col-sm-5 col-xs-3">
                                <nav class="main__menu__nav hidden-xs hidden-sm">
                                    <ul class="main__menu">
                                        ...
                                        <li class="drop"><a href="/product">Product</a>
                                        </li>
                                        </li>
                        ...
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="https://file.hstatic.net/1000327709/file/thoi-trang-nam-dep__2__6fb4c15a032c4d5f905f1bd68e638473_grande.jpg" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="section__title--2 text-center">
                            <h2 class="title__line">New Clothings</h2>
                ...
                <div class="htc__product__container">
                    <div class="row">
                        <div class="product__list clearfix mt--30">
                            <c:forEach items="${requestScope.List.get(0)}" var="Product">
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    ...
                                    <div class="fr__product__inner">
                                        <h4><a href="/product-details?productId=${Product.id}">${Product.name}</a></h4>
                                        <ul class="fr__pro__prize">
                                            <li class="old__prize">${Product.price} VND</li>
                                            <li>Con ${Product.soluong} sp</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="product__wrap clearfix">
                        <!-- Start Single Category -->
                        <c:forEach items="${requestScope.List.get(1)}" var="Product">
                        <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                            <div class="category">
                                <div class="ht__cat__thumb">
                                    <a href="/product-details?productId=${Product.id}">
